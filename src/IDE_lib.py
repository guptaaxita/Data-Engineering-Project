...
def create_reports(input_path, output_path, input_filename, output_filename):
    ...
    print('There are {} products:'.format(len(set(list_product))))
    ...
    print('Total number of complaints for each product and year: ')
    ...
    print('Total number of companies for each product and year: ')
    for prod_yr in set(prod_yr_list):
        print('"', prod_yr[0], '", ', prod_yr[1], ', ',
